...
Requiere AutoJs6 con código de versión no inferior a 5275 (es decir, 6.8.0 o posterior) firmado con el mismo certificado que el plugin; Android 24+ (Android 7.0), targetSdk 36; el dispositivo debe ser `arm64-v8a`. Versión de protocolo del plugin 1.0; versión actual del provider 0.1.0 (código de versión 2).
