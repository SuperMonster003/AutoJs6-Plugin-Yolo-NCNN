...
يتطلب AutoJs6 برمز إصدار لا يقل عن 5275 (أي 6.8.0 أو أحدث) موقّعًا بشهادة الإضافة نفسها؛ و Android 24+ (Android 7.0)، و targetSdk 37؛ ويجب أن يكون الجهاز `arm64-v8a, armeabi-v7a, x86, x86_64`. إصدار بروتوكول الإضافة 1.0؛ وإصدار المزوّد الحالي 0.1.3 (رمز الإصدار 36).
