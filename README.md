...
- 超时与生命周期可控: 模型打开与单次检测均有超时上限; `detector.close()` 与脚本停止可立即释放会话与原生资源.
...
* [CHANGELOG-zh-Hans.md](https://github.com/SuperMonster003/AutoJs6-Plugin-Yolo-NCNN/blob/master/.changelog/CHANGELOG-zh-Hans.md)
