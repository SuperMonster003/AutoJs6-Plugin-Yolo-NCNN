...
* `Примечание` Первый выпуск (код версии 36, без предшественника с кодом 1); требуется AutoJs6 с кодом версии не ниже 5275 (6.8.0+), подписанный тем же сертификатом, что и плагин
